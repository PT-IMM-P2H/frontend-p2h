...
import { MagnifyingGlassIcon, Bars3BottomLeftIcon, ArrowUpTrayIcon, ArrowDownTrayIcon, TrashIcon, UserPlusIcon, CloudArrowUpIcon, PencilSquareIcon, XMarkIcon, ChevronDownIcon } from "@heroicons/vue/24/outline";
...
const selectRow = (rowId) => {
  ...
  selectAllChecked.value = selectedRowIds.value.length === tableData.value.length;
};
  ...
  <div class="min-h-screen flex flex-col font-['Montserrat']">
    <div class="flex flex-1 overflow-hidden">
      ...
      <div class="flex flex-col flex-1 overflow-hidden">
        ...
        <!-- Content -->
        <main
          class="bg-[#EFEFEF] flex-1 flex flex-col p-3 overflow-hidden">
          ...
          <div class="bg-white rounded-lg shadow-md p-5 flex-1 flex flex-col overflow-hidden">
            <!-- Toolbar -->
            <div class="flex items-center gap-3 mb-4 pb-4 border-b shrink-0 flex-none justify-between">
              <!-- Left Section -->
              ...
              <div class="flex items-center gap-3">
                ...
                <button 
                  ...
                  :class="selectedRowIds.length > 0 ? 'bg-red-100 text-red-700 border border-red-300 hover:bg-red-200' : 'bg-gray-100 text-gray-400 border border-gray-300 cursor-not-allowed'"
                >
                ...
                <table class="w-full border-collapse">
                  <thead>
                    <tr class="border-b-2 border-gray-400 bg-gray-50">
                      <th class="px-4 py-3 text-left font-semibold text-gray-700 whitespace-nowrap min-w-12">
                        <input 
                          type="checkbox" 
                          ...
                          :style="selectAllChecked ? { backgroundColor: '#3b82f6', borderColor: '#3b82f6' } : { backgroundColor: 'white', borderColor: '#4b5563' }"
                          title="Pilih semua / Batal pilih semua"
                        />
                      </th>
                      <th class="px-4 py-3 text-left text-sm font-semibold text-gray-700 whitespace-nowrap min-w-32">Nama Lengkap</th>
                      <th class="px-4 py-3 text-left text-sm font-semibold text-gray-700 whitespace-nowrap min-w-24">No. Handphone</th>
                      <th class="px-4 py-3 text-left text-sm font-semibold text-gray-700 whitespace-nowrap min-w-28">Departemen</th>
                      <th class="px-4 py-3 text-left text-sm font-semibold text-gray-700 whitespace-nowrap min-w-20">Posisi</th>
                      <th class="px-4 py-3 text-left text-sm font-semibold text-gray-700 whitespace-nowrap min-w-20">Status</th>
                      <th class="px-4 py-3 text-left text-sm font-semibold text-gray-700 whitespace-nowrap min-w-28">Nama Perusahaan</th>
                      <th class="px-4 py-3 text-left text-sm font-semibold text-gray-700 whitespace-nowrap min-w-16">Edit</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr 
                    ...
                    >
                      <td class="px-4 py-3 whitespace-nowrap min-w-12">
                        <input 
                          ...
                          style="appearance: none; -webkit-appearance: none; -moz-appearance: none;"
                          :style="isRowSelected(row.id) ? { backgroundColor: '#3b82f6', borderColor: '#3b82f6' } : { backgroundColor: 'white', borderColor: '#4b5563' }"
                        />
                      </td>
                      <td class="px-4 py-3 text-gray-800 whitespace-nowrap min-w-32 text-xs">{{ row.namaLengkap }}</td>
                      <td class="px-4 py-3 text-gray-800 text-xs whitespace-nowrap min-w-24">{{ row.noHandphone }}</td>
                      <td class="px-4 py-3 text-gray-800 text-xs whitespace-nowrap min-w-28">{{ row.departemen }}</td>
                      <td class="px-4 py-3 text-gray-800 text-xs whitespace-nowrap min-w-20">{{ row.posisi }}</td>
                      <td class="px-4 py-3 text-gray-800 text-xs whitespace-nowrap min-w-20">{{ row.status }}</td>
                      <td class="px-4 py-3 text-gray-800 text-xs whitespace-nowrap min-w-28">{{ row.namaPerusahaan }}</td>
                      <td class="px-4 py-3 text-gray-800 text-xs whitespace-nowrap min-w-16">
