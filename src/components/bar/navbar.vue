...
<template>
    <header class="fixed top-0 left-0 w-full z-50 bg-white/80 backdrop-blur-md shadow-lg px-6 py-4 flex justify-between items-center">
        <div class="flex items-center gap-2">
            <img src="/image_asset/IMM.svg" alt="Logo" class="h-8 w-auto">
            <hr class="h-8 border-l-3 border-[#b7b7b7] rounded-lg" />
            <span class="font-montserrat font-medium text-1xl text-[#523E95] position-bottom hidden sm:block">
    ...
    <transition
        ...
        <nav v-if="isMenuOpen" class="md:hidden fixed top-16 left-0 w-full bg-white/95 backdrop-blur-md shadow-lg z-40">
