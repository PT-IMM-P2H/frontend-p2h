  ...
  <div class="min-h-screen flex flex-col font-['Montserrat']">
    ...
    >
      <div class="flex flex-col w-full max-w-5xl gap-4">
        ...
        <!-- Konten Informasi Kondisi Kerusakan -->
        <div class="p-8 md:p-10 bg-white rounded-lg shadow-md w-full mx-auto">
          ...
          <div class="flex flex-col gap-1">
            <!-- Normal -->
            <div>
              <div class="inline-block px-4 py-2 text-base font-bold rounded-full mb-1" style="background-color: #A7E8BF; color: #1A5C3F;">
                Normal
              </div>
              <p class="text-gray-700 font-regular text-base leading-relaxed mb-2">
            ...
            <!-- Abnormal -->
            <div>
              <div class="inline-block px-4 py-2 text-base font-bold rounded-full mb-1" style="background-color: #F7E19C; color: #8B6F47;">
                Abnormal
              </div>
              <p class="text-gray-700 font-regular text-base leading-relaxed mb-2">
            ...
            <!-- Warning -->
            <div>
              <div class="inline-block px-4 py-2 text-base font-bold rounded-full mb-1" style="background-color: #FFA0A0; color: #8B3A3A;">
                Warning
              </div>
              <p class="text-gray-700 font-regular text-base leading-relaxed mb-2">
